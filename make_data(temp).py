...
first_name_samples = '김이박최정강조윤송장임장'
middle_name_samples = '민서예정지은도하주윤채지현지강'
last_name_samples = '준윤우원호후서연민원아은진용'
...
API_KEY = 'e78b380f803d6c8e8ccf9c1359cae910'
...
for product in baseList:
    financial_products.append(product['fin_prdt_nm'])
...
save_dir = 'back/accounts/fixtures/accounts/user_data3.json'
with open(save_dir, 'w', encoding="utf-8") as f:
    ...
    for i in range(N):
        ...
        file['fields'] = {
            ...
            'money': random.randrange(0, 100000000, 1000000),  # 현재 가진 금액
            'salary': random.randrange(0, 10000000, 100000),  # 연봉
            'password': '1234',
            'nickname': 'admin',
            'is_active': True,
            'is_staff': False,
